...
function buildGoogleFeedbackLoop({ gsc, pagespeed, contentQuality, cannibalization, intentDifferentiation, conversionIntelligence, croExperiment }) {
  const actions = [];
  if (!gsc?.configured) {
...
async function run() {
  ...
  const googleFeedbackLoop = buildGoogleFeedbackLoop({ gsc, pagespeed, contentQuality, cannibalization, intentDifferentiation, conversionIntelligence, croExperiment });
