...
const checks=[
  ...
  ["monitor-covers-imap-review-backlog",monitor.includes("inspectImapInbox")&&monitor.includes("imap-review-backlog-alerted")&&monitor.includes("alert_delivery_verified")&&monitor.includes("pending_unmatched")],
