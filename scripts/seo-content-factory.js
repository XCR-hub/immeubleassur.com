...
function enhanceAdminPage() {
  ...
  const salesBlock = `<section class="plain-panel admin-seo-panel admin-sales-panel"><h2>Centre de relance commerciale</h2><div class="admin-toolbar"><button class="submit-button" type="button" id="load-sales">Charger relances</button><span class="admin-muted">SLA, scripts de rappel et priorites commerciales depuis D1.</span></div><div class="seo-admin-grid" id="sales-summary"><p>Charge relances dues, pipeline estime, leads chauds et scripts de rappel.</p></div><section class="admin-table-wrap" aria-label="Centre de relance commerciale"><table class="admin-table admin-sales-table"><thead><tr><th>Type</th><th>Lead</th><th>Valeur</th><th>Signal</th><th>Action</th></tr></thead><tbody id="sales-body"><tr><td colspan="5">Aucun chargement effectue.</td></tr></tbody></table></section></section>`;
