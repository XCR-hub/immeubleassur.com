...
const articleAngles = {
  "devis-assurance-immeuble-complet": { summary: ["Inventorier les pieces avant toute consultation.", "Qualifier lots, usages, surfaces, sinistres et travaux.", "Transformer les documents en fiche risque transmissible."], contextTitle: "Un guide documentaire, distinct du formulaire de devis.", context: "Cette page explique comment constituer un dossier complet. Elle ne compare ni les offres ni le calendrier: elle inventorie les donnees qui permettent a un assureur de comprendre le batiment.", documentsTitle: "La checklist du dossier immeuble.", documents: "Reunissez contrat et appel de prime, adresse, annee, surfaces, lots, usages, commerces, equipements, sinistres sur 36 mois, mesures correctives et travaux votes ou prevus.", contractTitle: "Controler la coherence des pieces.", contract: "Les surfaces, usages et sinistres doivent raconter le meme risque dans le questionnaire, le contrat actuel et les justificatifs.", methodTitle: "Passer des documents a la fiche risque.", method: "ImmeubleAssur classe les pieces, signale les informations absentes et resume le batiment avant transmission.", ctaNeed: "multirisque-immeuble" },
  "devis-assurance-immeuble-echeance": { summary: ["Commencer deux a trois mois avant l echeance.", "Integrer preavis, consultation, relances et validation.", "Eviter une decision sous contrainte de calendrier."], contextTitle: "Un retroplanning de renouvellement, pas un comparateur.", context: "Cette page organise le temps avant l echeance annuelle: collecte, consultation du marche, reponses, clarification des reserves et decision.", documentsTitle: "Les jalons avant la date limite.", documents: "A J-90, rassemblez contrat et sinistres; a J-60, finalisez la fiche risque; a J-45, lancez les consultations; avant J-30, clarifiez les conditions.", contractTitle: "Verifier echeance, preavis et continuite.", contract: "La date d echeance, les modalites de resiliation et la prise d effet du nouveau contrat doivent etre alignees.", methodTitle: "Piloter la consultation dans le temps.", method: "ImmeubleAssur associe chaque jalon a un responsable et a une piece attendue, puis reserve la validation finale au client.", ctaNeed: "audit-contrat" },
  "devis-assurance-immeuble-comparatif": { summary: ["Comparer les offres sur un perimetre identique.", "Isoler franchises, plafonds, exclusions et sous-limites.", "Documenter les ecarts avant de retenir une proposition."], contextTitle: "Une grille d arbitrage entre offres recues.", context: "Cette page intervient apres reception des propositions. Elle explique comment construire un tableau comparable, sans confondre cotisation basse et protection equivalente.", documentsTitle: "Les colonnes d une comparaison exploitable.", documents: "Alignez prime TTC, franchises par garantie, plafonds, sous-limites, exclusions, obligations de prevention, assistance et gestion des sinistres.", contractTitle: "Traiter les ecarts de garanties.", contract: "Toute difference de prix doit etre rapprochee d une difference de couverture ou de service.", methodTitle: "Produire une recommandation lisible.", method: "ImmeubleAssur normalise les propositions dans une meme grille et documente les points a faire confirmer.", ctaNeed: "audit-contrat" },
  "devis-courtier-assurance-immeuble": { summary: ["Comprendre le role du courtier dans le placement.", "Tracer les assureurs consultes et leurs reserves.", "Faire valider la recommandation par le client."], contextTitle: "Le processus de courtage et la validation humaine.", context: "Cette page decrit l intervention du courtier: qualification du risque, choix des partenaires, suivi des retours et presentation d une recommandation.", documentsTitle: "Ce que le courtier transmet au marche.", documents: "Le courtier consolide fiche risque, contrat actuel, sinistres, travaux et attentes de garanties. Il conserve la trace des consultations et propositions.", contractTitle: "Distinguer placement, conseil et decision.", contract: "Le courtier explique les ecarts et les reserves; le client valide la couverture retenue.", methodTitle: "Un placement documente de bout en bout.", method: "ImmeubleAssur qualifie les partenaires pertinents, organise les relances et restitue les offres avec leurs limites.", ctaNeed: "audit-contrat" },
...
function cityPage(city) {
  ...
  const localEvidence = slug === "paris" ? `<section class="band city-evidence-band"><div class="container narrow"><p class="eyebrow dark">Donnees publiques locales</p><h2>Paris : trois verifications avant de presenter l immeuble.</h2><div class="local-proof-grid"><article><h3>Adresse exacte</h3><p>Le rapport communal donne un premier contexte, puis la verification doit etre faite a l adresse sur Georisques.</p></article><article><h3>Sous-sol et caves</h3><p>La Ville de Paris propose un renseignement sur les carrieres souterraines pour documenter sous-sols, caves et travaux.</p></article><article><h3>Zones inondables</h3><p>Les cartes parisiennes completent l historique de sinistres et les mesures de prevention.</p></article><article><h3>Travaux</h3><p>Ravalement, toiture, reseaux et renovation energetique doivent etre decrits avec leurs justificatifs.</p></article></div><div class="source-box"><strong>Sources publiques pour l adresse</strong><a href="https://www.georisques.gouv.fr/mes-risques/connaitre-les-risques-pres-de-chez-moi/rapport2/75056/Paris/commune/75000" rel="noopener">Georisques - rapport communal Paris</a><a href="https://www.paris.fr/pages/plans-donnees-et-documents-d-urbanisme-3708" rel="noopener">Ville de Paris - sous-sol, parcelles et zones inondables</a><a href="https://www.apur.org/fr/nos-travaux/consommations-reelles-energie-logements-parisiens-2023-volet-2-parc-prive-operations-renovation" rel="noopener">Apur - parc prive et renovations parisiennes</a></div><p class="legal-note">Ces sources documentent le risque. Le contrat et l analyse de l assureur determinent la couverture.</p></div></section>` : slug === "lyon" ? `<section class="band city-evidence-band"><div class="container narrow"><p class="eyebrow dark">Donnees publiques locales</p><h2>Lyon : verifier eau, sous-sol et adresse.</h2><div class="local-proof-grid"><article><h3>Inondation</h3><p>Georisques recense un PPRI Lyon-Villeurbanne. Le zonage doit etre verifie a l adresse.</p></article><article><h3>Nappes et ruissellement</h3><p>Sous-sols, caves et reseaux doivent etre documentes selon l exposition locale et les mesures de prevention.</p></article><article><h3>Mouvements de terrain</h3><p>La topographie et la stabilite des terrains peuvent appeler des informations complementaires selon le secteur.</p></article><article><h3>Travaux</h3><p>Toiture, facade, etancheite et gestion des eaux pluviales doivent etre presentes avec leurs justificatifs.</p></article></div><div class="source-box"><strong>Sources publiques pour l adresse</strong><a href="https://www.georisques.gouv.fr/mes-risques/connaitre-les-risques-pres-de-chez-moi/rapport2/69123/Lyon/commune/69000" rel="noopener">Georisques - rapport communal Lyon</a><a href="https://www.georisques.gouv.fr/mes-risques/connaitre-les-risques-pres-de-chez-moi/detail/INOND?adresse=69123+Lyon&amp;codeInsee=69123&amp;commune=Lyon&amp;postCode=69000&amp;type=commune" rel="noopener">Georisques - inondation et PPRI Lyon</a><a href="https://www.grandlyon.com/mes-services-au-quotidien/gerer-son-eau/les-guides-et-outils-reglementaires" rel="noopener">Metropole de Lyon - eaux pluviales</a></div><p class="legal-note">Verification a l adresse requise; le contrat determine la couverture.</p></div></section>` : slug === "marseille" ? `<section class="band city-evidence-band"><div class="container narrow"><p class="eyebrow dark">Donnees publiques locales</p><h2>Marseille : verifier eau, terrain et feu.</h2><div class="local-proof-grid"><article><h3>Inondation</h3><p>La Ville identifie crues torrentielles, ruissellement urbain et submersion marine; l exposition varie selon l adresse.</p></article><article><h3>Mouvements de terrain</h3><p>Falaises, terrains instables, sous-sols et soutenements doivent etre declares lorsqu ils concernent le batiment.</p></article><article><h3>Feu de foret</h3><p>Le PPRIF et les obligations de debroussaillement doivent etre verifies pour les biens proches des massifs.</p></article><article><h3>Prevention</h3><p>Acces des secours, toiture, vegetation, evacuation des eaux et travaux recents completent le dossier.</p></article></div><div class="source-box"><strong>Sources publiques pour l adresse</strong><a href="https://www.marseille.fr/environnement/gestion-des-risques" rel="noopener">Ville de Marseille - cartes des risques</a><a href="https://www.marseille.fr/environnement/gestion-des-risques/risques-majeurs/inondations" rel="noopener">Ville de Marseille - inondations</a><a href="https://www.marseille.fr/environnement/obligations-legales-debroussaillement" rel="noopener">Ville de Marseille - debroussaillement</a></div><p class="legal-note">Verification a l adresse requise; le contrat determine la couverture.</p></div></section>` : slug === "bordeaux" ? `<section class="band city-evidence-band"><div class="container narrow"><p class="eyebrow dark">Donnees publiques locales</p><h2>Bordeaux : verifier Garonne, eau et parcelle.</h2><div class="local-proof-grid"><article><h3>Inondation</h3><p>La Metropole cite l inondation parmi les risques majeurs; l exposition doit etre verifiee a l adresse.</p></article><article><h3>PPRI et parcelle</h3><p>Les documents d urbanisme permettent de consulter le PPRI applicable avant travaux ou declaration du risque.</p></article><article><h3>Sous-sols</h3><p>Caves, parkings, evacuation des eaux et equipements situes en point bas doivent etre documentes.</p></article><article><h3>Prevention</h3><p>Digues et ouvrages collectifs ne remplacent pas les mesures propres au batiment.</p></article></div><div class="source-box"><strong>Sources publiques pour l adresse</strong><a href="https://www.georisques.gouv.fr/mes-risques/connaitre-les-risques-pres-de-chez-moi/rapport2/33063/Bordeaux/commune/33000" rel="noopener">Georisques - rapport communal Bordeaux</a><a href="https://www.bordeaux-metropole.fr/a-votre-service/services-aux-particuliers/environnement-sante/reagir-en-cas-dincident-majeur" rel="noopener">Bordeaux Metropole - risques majeurs</a><a href="https://entreprendre.bordeaux-metropole.fr/projets-immobiliers-fonciers-urbanisme/documents-durbanisme-reglementaires-bordeaux-metropole" rel="noopener">Bordeaux Metropole - PPRI et urbanisme</a></div><p class="legal-note">Verification a l adresse requise; le contrat determine la couverture.</p></div></section>` : slug === "lille" ? `<section class="band city-evidence-band"><div class="container narrow"><p class="eyebrow dark">Donnees publiques locales</p><h2>Lille : verifier eau, cavites et sous-sol.</h2><div class="local-proof-grid"><article><h3>Inondation</h3><p>Le DICRIM de Lille recense l inondation parmi les risques majeurs; l exposition varie selon l adresse.</p></article><article><h3>Cavites</h3><p>La Ville documente les mouvements de terrain et les carrieres souterraines, ou catiches.</p></article><article><h3>Caves et reseaux</h3><p>Etat des caves, humidite, pompes, canalisations et mesures de prevention doivent etre precises.</p></article><article><h3>Historique</h3><p>Sinistres, reprises structurelles et travaux realises completent l analyse du batiment.</p></article></div><div class="source-box"><strong>Sources publiques pour l adresse</strong><a href="https://www.georisques.gouv.fr/mes-risques/connaitre-les-risques-pres-de-chez-moi/rapport2/59350/Lille/commune/59000" rel="noopener">Georisques - rapport communal Lille</a><a href="https://www.lille.fr/Votre-Mairie/Lille-en-bref/Une-ville-attentive-a-chacun/Pollution-inondation-rappel-sur-les-risques-majeurs" rel="noopener">Ville de Lille - DICRIM et risques majeurs</a></div><p class="legal-note">Verification a l adresse requise; le contrat determine la couverture.</p></div></section>` : slug === "nantes" ? `<section class="band city-evidence-band"><div class="container narrow"><p class="eyebrow dark">Donnees publiques locales</p><h2>Nantes : verifier Loire, ruissellement et sous-sols.</h2><div class="local-proof-grid"><article><h3>Cours d eau</h3><p>Loire, Erdre et Sevre nantaise font partie des expositions a verifier selon l adresse.</p></article><article><h3>Ruissellement</h3><p>Les pluies intenses peuvent toucher des zones basses, y compris loin d un grand cours d eau.</p></article><article><h3>Caves et parkings</h3><p>La Metropole recommande de ne pas stocker de biens de valeur dans les sous-sols exposes.</p></article><article><h3>PPRI</h3><p>Trois PPRI couvrent le territoire metropolitain; la parcelle et les mesures de prevention doivent etre consultees.</p></article></div><div class="source-box"><strong>Sources publiques pour l adresse</strong><a href="https://www.georisques.gouv.fr/mes-risques/connaitre-les-risques-pres-de-chez-moi/rapport2/44109/Nantes/commune/44000" rel="noopener">Georisques - rapport communal Nantes</a><a href="https://metropole.nantes.fr/mes-services-mon-quotidien/connaitre-et-se-preparer-aux-risques-majeurs" rel="noopener">Nantes Metropole - risques majeurs</a><a href="https://metropole.nantes.fr/mes-services-mon-quotidien/s-informer-sur-les-risques-d-inondation" rel="noopener">Nantes Metropole - inondation et PPRI</a></div><p class="legal-note">Verification a l adresse requise; le contrat determine la couverture.</p></div></section>` : "";
  const body = `<section class="page-hero compact-hero"><div class="container"><p class="eyebrow">Assurance immeuble ${esc(name)}</p><h1>Assurance immeuble a ${esc(name)}.</h1><p>ImmeubleAssur accompagne ${esc(focus)} avec une analyse concrete des garanties, franchises, exclusions et documents attendus par les assureurs.</p><div class="hero-actions"><a class="button primary" href="#devis">Devis immeuble ${esc(name)}</a><a class="button secondary" href="/villes.html">Toutes les villes</a></div></div></section><section class="band page-band"><div class="split"><div><p class="eyebrow dark">${esc(department)} - ${esc(region)}</p><h2>Un dossier local centre sur ${esc(angle)}.</h2><p class="large-copy">A ${esc(name)}, la question n'est pas seulement de trouver une assurance immeuble. Il faut presenter le batiment de facon exploitable: usage, lots, entretien, sinistres, travaux, activites en rez-de-chaussee et responsabilites.</p><ul class="check-list"><li>Multirisque immeuble pour copropriete, SCI ou monopropriete.</li><li>PNO bailleur et coherence avec les contrats occupants.</li><li>Audit des franchises degats des eaux, incendie, vandalisme et evenements climatiques.</li><li>Preparation d'une fiche risque claire pour assureurs.</li></ul></div>${leadForm({ city: name, need: "multirisque-immeuble" })}</div></section><section class="band seo-band"><div class="section-head"><p class="eyebrow dark">Analyse du risque</p><h2>Ce que nous documentons avant consultation.</h2></div><div class="local-proof-grid"><article><h3>Batiment</h3><p>Adresse, annee approximative, nombre de lots, surface, parties communes, toiture, facade, reseaux et equipements techniques.</p></article><article><h3>Occupation</h3><p>Lots loues, vacants, occupes, locaux commerciaux, parkings, caves, dependances et activites declarees au bail.</p></article><article><h3>Sinistres</h3><p>Historique 36 mois, causes, montants, recurrence, recherche de fuite, mesures correctives et pieces disponibles.</p></article><article><h3>Arbitrage</h3><p>Comparaison de la prime avec franchises, plafonds, exclusions, delais de declaration et qualite du service sinistre.</p></article></div></section><section class="band faq-band"><div class="container narrow"><h2>FAQ assurance immeuble ${esc(name)}</h2><div class="faq-list"><details><summary>Pourquoi demander un devis specialise a ${esc(name)} ?</summary><p>Parce qu'un immeuble doit etre presente selon son usage, son entretien et ses sinistres. Une fiche risque locale evite les approximations et facilite la comparaison.</p></details><details><summary>La ville change-t-elle le prix de l'assurance ?</summary><p>La localisation peut influencer l'appetence assureur, mais elle ne suffit pas. L'occupation, les travaux, les sinistres et les franchises pesent souvent davantage.</p></details><details><summary>Quels documents preparer ?</summary><p>Contrat actuel, appel de prime, sinistres 36 mois, lots, surface, travaux prevus, photos si utiles et informations syndic ou bailleur.</p></details></div></div></section>${localEvidence}`;
...
function strategyPage() {
  ...
  return layout({ slug: "strategie-seo-continue", title: "Systeme SEO continu", description: "Methode ImmeubleAssur pour piloter le SEO: contenus utiles, audits, Google Search Console, PageSpeed et conversions.", body }).replace('<meta name="robots" content="index, follow, max-image-preview:large" />', '<meta name="robots" content="noindex, follow" />');
}
...
function enhanceAdminPage() {
  ...
  const contentBlock = `<section class="plain-panel admin-seo-panel admin-content-panel" id="editorial-review" tabindex="-1"><h2>Pipeline contenu SEO</h2><div class="admin-toolbar"><button class="submit-button" type="button" id="load-content">Charger contenu</button><a class="button secondary" data-track="cta-secondary" href="/recherches-assurance-immeuble">Voir hub recherches</a></div><div class="seo-admin-grid" id="content-summary"><p>Charge articles, FAQ, villes, opportunites et veille editoriale.</p></div><section class="admin-table-wrap" aria-label="Brouillons IA en quarantaine"><h3>Revue humaine des brouillons IA</h3><p class="admin-muted">Aucune decision ne publie le texte. Un brouillon peut seulement etre rejete ou conserve comme reference interne.</p><table class="admin-table"><thead><tr><th>Priorite</th><th>Brouillon</th><th>Age</th><th>Risque</th><th>Action</th></tr></thead><tbody id="editorial-review-body"><tr><td colspan="5">Charger le contenu pour afficher la file.</td></tr></tbody></table></section><section class="admin-table-wrap" id="editorial-review-detail" hidden aria-live="polite"><h3 id="editorial-review-title">Brouillon en revue</h3><p class="admin-muted" id="editorial-review-meta"></p><pre id="editorial-review-text"></pre><div id="editorial-review-sources"></div><div class="admin-toolbar"><label for="editorial-reviewer">Relecteur</label><input id="editorial-reviewer" type="text" maxlength="120" autocomplete="name"><label for="editorial-review-reason">Motif documente</label><input id="editorial-review-reason" type="text" maxlength="1000" placeholder="Verification effectuee et justification"><button class="button secondary compact-button" type="button" data-editorial-decision="reference_only">Conserver comme reference interne</button><button class="button secondary compact-button" type="button" data-editorial-decision="rejected">Rejeter le brouillon</button><button class="button secondary compact-button" type="button" id="editorial-review-close">Fermer</button></div><p class="admin-muted" id="editorial-review-status"></p></section><section class="admin-table-wrap" aria-label="Pipeline contenu"><table class="admin-table admin-content-table"><thead><tr><th>Type</th><th>Score</th><th>Page</th><th>Signal</th><th>Action</th></tr></thead><tbody id="content-body"><tr><td colspan="5">Aucun chargement effectue.</td></tr></tbody></table></section></section>`;
...
function enhanceHubs(generatedCities) {
  injectBlock(join(OUT, "blog.html"), "seo-content-factory-blog", `<section class="band content-expansion-band"><div class="section-head"><p class="eyebrow dark">Nouveaux guides experts</p><h2>Guides pratiques pour assurer chaque type d'immeuble.</h2></div><div class="card-grid">${articleBlueprints.slice(0, 18).map((item) => `<article class="content-card"><p class="eyebrow dark">${esc(item.category)}</p><h3><a href="/blog/${item.slug}.html">${esc(item.title)}</a></h3><p>${esc(item.description)}</p></article>`).join("")}</div></section>`);
...
function enhanceCityDepth() {
  ...
  for (const fileName of files) {
    ...
    const rawName = (html.match(/<h1[^>]*>Assurance immeuble a ([^.<]+)\.?<\/h1>/i) || [])[1];
    if (!rawName) {
      writeFileSync(file, html, "utf8");
      continue;
    }
    const city = esc(rawName.trim());
    const block = `<section class="band city-depth-band"><div class="container narrow"><p class="eyebrow dark">Dossier local</p><h2>Comment preparer un devis assurance immeuble a ${city}.</h2><p class="large-copy">Pour preparer une demande locale, le syndic, le bailleur ou la SCI doit comprendre les informations examinees par l'assureur. Pour ${city}, ImmeubleAssur qualifie le batiment, l'occupation, les sinistres, les travaux, les franchises et les garanties attendues avant de comparer les propositions.</p><div class="local-proof-grid"><article><h3>Pieces utiles</h3><p>Contrat actuel, appel de prime, historique sinistres 36 mois, nombre de lots, surfaces, photos si besoin, travaux votes et informations syndic.</p></article><article><h3>Garanties</h3><p>Responsabilite civile immeuble, dommages, degats des eaux, incendie, vandalisme, evenements climatiques, recherche de fuite et protection juridique.</p></article><article><h3>Arbitrage</h3><p>Comparer la prime avec les franchises, plafonds, exclusions, obligations d'entretien et delais de declaration pour mesurer le cout reel.</p></article><article><h3>Demande de devis</h3><p>Le formulaire structure les informations du risque pour limiter les allers-retours et accelerer la consultation.</p></article></div><div class="faq-list"><details><summary>Quel est le meilleur moment pour comparer un contrat a ${city} ?</summary><p>Deux a trois mois avant echeance. Cela laisse le temps de relire le contrat, completer les pieces et consulter sans urgence.</p></details><details><summary>Un immeuble avec commerce est-il plus difficile a assurer ?</summary><p>Il peut demander plus de precision. L'activite, le bail, les installations techniques et les garanties du locataire doivent etre decrits clairement.</p></details><details><summary>Pourquoi fournir l'historique sinistres ?</summary><p>Parce qu'un historique explique permet de distinguer un incident isole d'un probleme recurrent et de montrer les mesures correctives deja prises.</p></details></div></div></section>`;
    html = html.replace("</main>", `\n<!-- city-depth:start -->\n${block}\n<!-- city-depth:end -->\n</main>`);
    writeFileSync(file, html, "utf8");
  }
}
