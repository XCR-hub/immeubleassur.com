...
$env:LOCAL_IMAP_UNMATCHED_ALERTS = '1'
$env:LOCAL_IMAP_UNMATCHED_ALERT_TO = 'team@immeubleassur.com'
$env:LOCAL_IMAP_UNMATCHED_ALERT_STATE = Join-Path $RuntimeRoot 'reports\imap-unmatched-alert-state.json'
