...
const nestedRuntimeAsset=await probe("/assets/assets/live-api-readiness-latest.json"); add("nested-runtime-assets-not-public",nestedRuntimeAsset.response?.status===404,{status:nestedRuntimeAsset.response?.status||0});
