...
const assets = {
  ...
  adminProfile: versionedAsset("/assets/admin-profile.js"),
...
const tagRules = [
  ...
  {
    name: "admin-profile",
    pattern: /<script\s+src="\/assets\/admin-profile\.js(?:\?v=[^"]*)?"\s+type="module"><\/script>/g,
    replacement: `<script src="${assets.adminProfile}" type="module"></script>`
  },  {
    name: "client-portal",
