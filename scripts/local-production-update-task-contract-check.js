...
const checks = [
  ...
  ["held-editorial-gate-refreshes-preserved-sitemap", publisher.includes("refreshPreservedRuntimeSitemap") && publisher.includes("preserved_sitemap_refreshed") && publisher.includes("held-by-publication-gate")]
];
