...
const required = [
  ...
  ["functions/api/admin/cases.js", "review_inbox_mail_no_case"],
  ["functions/api/admin/cases.js", "imap-inbox-human-review-v1"],
  ["public/assets/admin.js", "Classer sans dossier"],
  ["public/admin.html", "inbox-mail-search"],
  ["public/assets/admin.js", "INBOX_MAIL_PAGE_SIZE=25"],
  ["public/assets/admin.js", "filteredInboxMails"],
  ["scripts/local-editorial-review-store.js", "editorial-human-review-v1"],
  ["functions/api/admin/editorial-review.js", "human-review-only"],
  ["scripts/local-production-server.js", '"/api/admin/editorial-review"'],
  ["scripts/local-production-server.js", "REVIEW_EDITORIAL_DRAFT"],
  ["public/admin.html", "editorial-review-body"],
  ["public/assets/styles.css", "admin-editorial-human-review-2026-08:start"],
  ["public/assets/admin.js", "postEditorialReviewDecision"],
  ["public/admin.html", "reference_only"],
  ["scripts/editorial-human-review-action-contract-check.js", "no auto publication"],
  ...
  ["scripts/local-runtime-report-cycle.js", "LOCAL_LIGHTHOUSE_REPORT"],
  ["scripts/local-lighthouse-monitor.js", "lighthouse-local"],
  ["scripts/local-lighthouse-monitor.js", "LOCAL_LIGHTHOUSE_MAX_LCP_MS"],
  ["scripts/live-ready-connectors-runner.js", "pagespeed-local"],
  ["package.json", "pagespeed:local"],
  ...
  ["scripts/lead-notification-retry-contract-check.js", "recovery_probe"],
  ["package.json", "leads:notifications:retry:check"],
  ...
  ["scripts/live-ready-connectors-runner.js", "collection_status"],
  ["scripts/live-ready-connectors-runner.js", "attention: attention.length"],
  ["scripts/editorial-autopilot.js", "minimum_healthy_sources"],
  ["scripts/editorial-autopilot.js", "source_results"],
  ...
  ["scripts/local-production-monitor.js", "missing-resend-config"],
  ["scripts/local-production-monitor.js", "transport: config.transport"],
