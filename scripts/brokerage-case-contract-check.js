...
const REQUIRED = [
  ...
  ["functions/api/admin/cases.js", "Email deja rattache a un dossier"],
  ["public/assets/admin.js", "Classer sans dossier"],
  ["public/assets/admin.js", "postInboxReviewNoCase"],
  ["public/admin.html", "inbox-mail-search"],
  ["public/admin.html", "inbox-mail-filter"],
  ["public/admin.html", "inbox-mail-count"],
  ["public/assets/admin.js", "INBOX_MAIL_PAGE_SIZE=25"],
  ["public/assets/admin.js", "filteredInboxMails"],
  ["public/assets/admin.js", "pending-unmatched"],
  ["public/assets/admin.js", "inboxMailNext"],
  ["scripts/brokerage-case-workflow-smoke.js", "inbox classification should preserve a human audit trail"],
  ["functions/api/admin/cases.js", "send_mail"],
  ["functions/api/admin/cases.js", "transportReady = resendMode"],
  ["functions/api/admin/cases.js", "Configuration Resend incomplete"],
  ["functions/_shared/smtp.js", "attachments: parsed.attachments"],
  ["functions/_shared/smtp.js", "const boundary = \"--\" + boundaryMatch[1]"],
  ...
  ["functions/api/partner/consultation.js", "insurer-partner-token-guard-v1"],
  ["functions/api/partner/consultation.js", "insurer_partner_token_failure"],
  ["functions/api/partner/consultation.js", "raw_token_stored: false"],
  ["functions/api/partner/consultation.js", "Retry-After"],
  ...
  ["functions/_shared/document-crypto.js", "document-encryption-aes-256-gcm-v1"],
  ["functions/_shared/document-crypto.js", "DOCUMENT_ENCRYPTION_REQUIRED"],
  ["functions/api/client/case.js", "encryptDocumentBase64"],
  ["functions/api/client/case.js", "decryptDocumentBase64"],
  ["functions/api/admin/cases.js", "decryptDocumentBase64"],
  ["scripts/local-document-encryption-migrate.js", "document-encryption-migration-v1"],
