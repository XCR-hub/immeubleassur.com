...
const moneyRows = `
assurance-immeuble-obligatoire|Assurance immeuble obligatoire: qui assure quoi|Assurance immeuble obligatoire: RC, copropriete, PNO, syndic, bailleur, garanties utiles, documents et dossier de devis personnalise.|Obligation|assurance immeuble obligatoire|syndics, conseils syndicaux, bailleurs et coproprietaires|distinguer l'obligation, la responsabilite civile et les garanties utiles|copropriete|syndic-professionnel|copropriete|/assurance-copropriete,/assurance-pno,/faq/copropriete,/devis-assurance-immeuble?intent=copropriete
 ...
 assurance-immeuble-de-rapport|Assurance immeuble de rapport pour bailleur|Assurance immeuble de rapport: multirisque, PNO, vacance, loyers, locaux mixtes, sinistres, audit bailleur et dossier de devis.|Immeuble de rapport|assurance immeuble de rapport|bailleurs d'immeubles entiers et proprietaires multi-lots|proteger le bati, les loyers, la responsabilite et les occupants|multirisque-immeuble|bailleur|immeuble-locatif|/assurance-immeuble-locatif,/blog/pertes-de-loyers-immeuble,/assurance-pno,/devis-assurance-immeuble?intent=bailleur
 ...
 assurance-immeuble-syndic-professionnel|Assurance syndic professionnel: contrats et portefeuille|Assurance immeuble pour syndic professionnel: portefeuille, echeances, sinistres, cahier des charges et comparaison des contrats de copropriete.|Syndic professionnel|assurance immeuble syndic professionnel|cabinets de syndic, gestionnaires de copropriete et administrateurs de biens|piloter les contrats immeuble a l echelle d un portefeuille avec une methode reproductible|copropriete|syndic-professionnel|copropriete|/assurance-copropriete,/rc-syndic,/audit-contrat-assurance-immeuble,/devis-assurance-immeuble?intent=copropriete
 assurance-immeuble-syndic-benevole|Assurance syndic benevole: mandat, archives et AG|Assurance immeuble syndic benevole: mandat, PV, archives, echeance, sinistres et note de vote pour petite copropriete.|Syndic benevole|assurance immeuble syndic benevole|syndics benevoles et petites coproprietes autogerees|securiser la gestion benevole avec mandat, archives et calendrier d'assemblee|copropriete|syndic-benevole|copropriete|/assurance-copropriete,/blog/syndic-benevole-assurance,/guide-assurance-copropriete-2026,/faq/copropriete
`;
...
const moneyIntentAngles = {
  ...
  "assurance-immeuble-syndic-professionnel": {
    decisionTitle: "Piloter les contrats immeuble d un portefeuille de coproprietes.",
    decisionCopy: "Cette page part du quotidien d un cabinet de syndic: inventaire des immeubles, echeances, historique des sinistres, cahiers des charges, consultations et restitution aux conseils syndicaux. Elle structure une methode de gestion reproductible sans formuler d interpretation juridique automatique.",
    checklist: ["Tableau du portefeuille: immeuble, assureur, prime, echeance et preavis.", "Contrat, dernier appel de prime et sinistres sur 36 mois par copropriete.", "Caracteristiques du risque: lots, surface, usages, commerces, equipements et travaux.", "Synthese comparable pour le conseil syndical et l assemblee generale."],
    cards: [["Portefeuille", "Centraliser les echeances et contrats evite les consultations tardives."], ["Sinistralite", "Une chronologie par immeuble rend les causes et mesures correctives lisibles."], ["Consultation", "Un cahier des charges stable permet de comparer les reponses assureurs."], ["Restitution", "Une synthese courte rapproche prime, franchises, exclusions et services." ]],
    expertiseTitle: "Une page concue pour la gestion professionnelle multi-immeubles.",
    expertiseCopy: "Le besoin d un syndic professionnel differe de celui d une copropriete autogeree: volumetrie, delegation interne, calendrier de renouvellement et reporting doivent rester coherents d un immeuble a l autre.",
    pitfallCopy: "Les erreurs evitees: echeance non anticipee, dossier incomplet, sinistres non consolides, garanties incomparables ou restitution trop technique pour la decision collective.",
    faq: [["Quelles donnees centraliser en premier ?", "Adresse, lots, surface, usages, assureur, prime, echeance, preavis et sinistres constituent le socle du portefeuille."], ["Comment comparer plusieurs offres ?", "Utiliser le meme cahier des charges puis rapprocher prime, franchises, plafonds, exclusions et services de gestion."], ["Quand lancer un renouvellement ?", "Assez tot pour reunir les pieces, analyser la sinistralite et respecter les delais contractuels propres a chaque dossier."], ["Cette page remplace-t-elle une analyse juridique ?", "Non. Toute question de responsabilite, mandat ou obligation doit etre validee humainement sur les textes et contrats applicables."], ["Comment preparer la restitution ?", "Une synthese par ecart significatif aide le conseil syndical ou l assemblee a arbitrer sans noyer la decision dans les conditions generales."]]
  },
...
function faq(page) {
  ...
  const rows = customRows || [
    ...
    ["Comment ImmeubleAssur transforme la demande ?", "La demande est qualifiee en fiche risque: informations certaines, points manquants, garanties sensibles, niveau de priorite et prochaine action."]
  ];
...
function landingPage(page) {
  ...
  const decisionTitle = angle.decisionTitle || `Preparer un dossier exploitable pour ${page.query}.`;
  const decisionCopy = angle.decisionCopy || `Pour ${page.audience}, ce besoin demande surtout de ${page.angle}. La bonne reponse ne se limite pas a une prime: elle doit expliquer quoi assurer, quelles pieces transmettre et quelles garanties comparer.`;
  const checklist = angle.checklist || ["Identifier le statut du demandeur, le type de bien, l'occupation, les lots et les responsabilites.", "Relire le contrat actuel: prime, echeance, franchises, plafonds, exclusions et delais de declaration.", "Documenter les sinistres, les travaux, la vacance, les locaux commerciaux et les mesures de prevention.", "Structurer les informations en fiche risque pour obtenir une proposition comparable."];
  ...
  const expertiseTitle = angle.expertiseTitle || "Pourquoi une analyse specialisee est utile.";
  const expertiseCopy = angle.expertiseCopy || `Elle clarifie une situation concrete pour ${page.audience}. Elle relie le besoin au parcours adapte: devis, audit, PNO/CNO, copropriete, SCI, prix ou sinistre.`;
