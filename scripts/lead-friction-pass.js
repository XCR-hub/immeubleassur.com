...
const systemEvidence = {
  ...
  content_bridge: app.includes("content-lead-bridge") && app.includes("content_lead_bridge_shown") && app.includes("routeWithAttribution") && app.includes("querySourcePath") && eventsApi.includes("content_lead_bridge_quote_click") && seoApi.includes("content_bridge_click_rate") && seoApi.includes("content_bridge_paths") && admin.includes("Pont contenu") && admin.includes("Top pont"),
