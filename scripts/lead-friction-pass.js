...
const systemEvidence = {
  ...
  content_bridge: app.includes("content-lead-bridge") && app.includes("content_lead_bridge_shown") && app.includes("routeWithAttribution") && app.includes("querySourcePath") && app.includes("queryContentBridge") && app.includes("content_bridge: attribution.content_bridge") && eventsApi.includes("content_lead_bridge_quote_click") && eventsApi.includes("content_kind: clean(payload.content_kind") && seoApi.includes("content_bridge_click_rate") && seoApi.includes("content_bridge_leads") && seoApi.includes("click_to_lead_rate") && seoApi.includes("content_bridge_paths") && admin.includes("Pont contenu") && admin.includes("Leads pont") && admin.includes("Top pont"),
