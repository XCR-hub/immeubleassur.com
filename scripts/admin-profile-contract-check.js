...
const expectations = [
  ["schema.sql", ["admin_profiles", "password_hash", "failed_login_count"]],
  ...
  ["functions/api/admin/auth.js", ["PBKDF2", "create_profile", "admin-profile-login-v1", "locked_until", "Identifiants invalides"]],
  ...
  ["scripts/admin-profile-workflow-smoke.js", ["PBKDF2 login", "CRM session", "readonly profile should not mutate CRM leads", "logged out operator session"]],
