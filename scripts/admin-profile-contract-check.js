...
const expectations = [
  ...
  ["functions/api/admin/auth.js", ["PBKDF2", "create_profile", "admin_auth_events", "login_failed", "login_rate_limited", "-15 minutes", "admin-profile-login-v1", "locked_until", "Identifiants invalides", "admin-auth-audit-v1", "-180 days", "admin-profile-password-changed-v1", "change_password", "admin-profile-invite-created-v1", "admin-profile-invite-accepted-v1", "create_invite", "accept_invite"]],
  ...
  ["public/assets/admin-profile.js", ["admin-profile-login", "create_profile", "sessionStorage", "history.replaceState", "admin-profile-status", "loadAuditEvents", "change_password", "admin-auth-events-body"]],
  ["scripts/admin-profile-workflow-smoke.js", ["PBKDF2 login", "persistent IP limiter", "CRM session", "readonly profile should not mutate CRM leads", "authentication audit must not store passwords, invitation tokens or session tokens", "logged out operator session"]],
