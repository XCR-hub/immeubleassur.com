...
function run() {
  ...
  const commonRuntimeEnv = {
    ...
    LOCAL_GITHUB_WORKFLOW_HEALTH_REPORT: join(runtimeReportsRoot, "local-github-workflow-health-report.json"),
    ...
    LOCAL_PRIVACY_RETENTION_REPORT: join(runtimeReportsRoot, "local-privacy-retention-report.json"),
  ...
  const steps = [
    ...
    runStep("privacy_retention_contract", ["scripts/privacy-retention-contract-check.js"], commonRuntimeEnv),
    runStep("privacy_retention", ["scripts/local-privacy-retention.js"], commonRuntimeEnv),
    ...
    runStep("github_workflow_health", ["scripts/local-github-workflow-health-monitor.js"], commonRuntimeEnv),
