...
const expectations = [
  { file: "functions/api/leads.js", snippets: ["assessSpamSubmission", "loadSpamHistory", "logSpamAttempt", "lead_spam_blocked", "spam_score", "honeypot-rempli", "signal-js-absent", "localChallengeStatus", "local-challenge", "verifyTurnstile", "TURNSTILE_SECRET_KEY", "TURNSTILE_ALLOWED_HOSTNAMES", "lead_form", "hostname-invalide", "action-invalide", "requestOriginStatus", "Origin", "Referer", "origin-failed", "origin-invalide", "referer-invalide", "turnstile-failed", "expectedSessionToken", "jeton-session-invalide", "email-jetable", "rafale-ip", "session-deja-bloquee"] },
  ...
  { file: "functions/api/newsletter.js", snippets: ["localNewsletterChallengeStatus", "assessNewsletterSpam", "loadNewsletterSpamHistory", "newsletter_spam_blocked", "spam_score", "email-jetable", "volume-ip-newsletter", "blockNewsletterSpam", "verifyNewsletterTurnstile", "TURNSTILE_SECRET_KEY", "TURNSTILE_ALLOWED_HOSTNAMES", "newsletter_subscribe", "hostname-invalide", "action-invalide", "requestOriginStatus", "Origin", "Referer", "origin-failed", "origin-invalide", "referer-invalide", "turnstile-failed", "newsletter_turnstile_token"] },
