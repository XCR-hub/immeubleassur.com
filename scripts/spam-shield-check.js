...
const expectations = [
  ...
  { file: "scripts/lead-dedupe-runtime-check.js", snippets: ["duplicate-does-not-create-new-lead", "lead_duplicate_filtered", "duplicate_site_events", "admin-duplicate-metrics-verified", "sales-duplicate-followup-verified", "getAdminSpam", "getAdminSeo", "getAdminIntegrations", "getAdminSales"] },
