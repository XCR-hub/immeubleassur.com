...
const expectations = [
  { file: "functions/api/leads.js", snippets: ["split(",")[0]", "assessSpamSubmission", "loadSpamHistory", "logSpamAttempt", "lead_spam_blocked", "spam_score", "honeypot-rempli", "signal-js-absent", "localChallengeStatus", "local-challenge", "verifyTurnstile", "TURNSTILE_SECRET_KEY", "TURNSTILE_ALLOWED_HOSTNAMES", "lead_form", "hostname-invalide", "action-invalide", "requestOriginStatus", "corsHeadersFor", "corsOriginAllowed", "DEFAULT_CORS_ORIGIN", "Vary", "Origin", "Referer", "origin-failed", "origin-invalide", "referer-invalide", "turnstile-failed", "expectedSessionToken", "jeton-session-invalide", "email-jetable", "rafale-ip", "session-deja-bloquee", "findRecentDuplicateLead", "leadDuplicateReason", "lead_duplicate_filtered", "duplicate_recent", "leadMailConfig", "buildDuplicateLeadEmail", "notifyDuplicateLeadByEmail", "duplicate_email_notification_sent", "duplicate_email_notification_failed"] },
  ...
  { file: "functions/api/admin/sales.js", snippets: ["lead_duplicate_filtered", "duplicateFollowupMap", "duplicate_followups", "retour-prospect", "duplicate_followup_value"] },
  { file: "public/assets/admin.js", snippets: ["Spam bloques", "spam-bloque", "robots filtres", "loadSpam", "/api/admin/spam", "Sources masquees", "Doublons filtres", "Retours prospect", "Dedupe leads", "doublon-filtre", "retour-prospect", "Anti-fraude local", "Turnstile"] },
  { file: "functions/api/events.js", snippets: ["split(",")[0]", "lead_spam_blocked", "ia_lead_spam_blocked", "lead_duplicate_returned", "ia_lead_duplicate_returned", "duplicate_reason", "challenge"] },
  { file: "functions/api/newsletter.js", snippets: ["split(",")[0]", "localNewsletterChallengeStatus", "assessNewsletterSpam", "loadNewsletterSpamHistory", "newsletter_spam_blocked", "spam_score", "email-jetable", "volume-ip-newsletter", "blockNewsletterSpam", "verifyNewsletterTurnstile", "TURNSTILE_SECRET_KEY", "TURNSTILE_ALLOWED_HOSTNAMES", "newsletter_subscribe", "hostname-invalide", "action-invalide", "requestOriginStatus", "corsHeadersFor", "corsOriginAllowed", "DEFAULT_CORS_ORIGIN", "Vary", "Origin", "Referer", "origin-failed", "origin-invalide", "referer-invalide", "turnstile-failed", "newsletter_turnstile_token"] },
  ...
  { file: "scripts/lead-dedupe-runtime-check.js", snippets: ["duplicate-does-not-create-new-lead", "lead_duplicate_filtered", "duplicate_site_events", "duplicate-email-skips-without-smtp", "duplicate_notification_events", "admin-duplicate-metrics-verified", "sales-duplicate-followup-verified", "getAdminSpam", "getAdminSeo", "getAdminIntegrations", "getAdminSales"] },
