...
const allowedEvents = new Set([
  ...
  "readiness_complete",
  "scroll_depth",
  "lead_magnet_checklist_click",
  "content_lead_bridge_shown",
  "content_lead_bridge_quote_click",
  "content_lead_bridge_phone_click",
  "content_lead_bridge_dismissed",
  "lead_form_rescue_shown",
  "lead_form_rescue_phone_click",
  "lead_form_rescue_express_click",
  "lead_form_rescue_dismissed",
  "lead_form_abandoned",
  "traffic_without_click_shown",
  "traffic_without_click_urgency_select",
...
const ga4EventNames = {
  ...
  lead_magnet_checklist_click: "ia_lead_magnet_checklist_click",
  content_lead_bridge_shown: "ia_content_lead_bridge_shown",
  content_lead_bridge_quote_click: "ia_content_lead_bridge_quote_click",
  content_lead_bridge_phone_click: "ia_content_lead_bridge_phone_click",
  content_lead_bridge_dismissed: "ia_content_lead_bridge_dismissed",
  lead_form_rescue_shown: "ia_lead_form_rescue_shown",
  lead_form_rescue_phone_click: "ia_lead_form_rescue_phone_click",
  lead_form_rescue_express_click: "ia_lead_form_rescue_express_click",
  ...
  traffic_without_click_urgency_select: "ia_traffic_without_click_urgency_select",
