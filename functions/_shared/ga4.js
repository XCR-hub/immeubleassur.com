...
function safeParamMap(params = {}) {
  const allowed = {
    ...
    content_bridge: clean(params.content_bridge, 20),
    content_kind: clean(params.content_kind, 80),
...
export function gaLeadParams({ payload = {}, record = {}, qualification = {}, reference = "" }) {
  ...
  return {
    ...
    content_bridge: record.content_bridge || payload.content_bridge || utm.content_bridge,
    content_kind: record.content_kind || payload.content_kind || utm.content_kind,
