...
async function loadSeo() {
  ...
  const fallbackRows = [
    ...
    ...(Number(funnel.traffic_rescue_shown || 0) ? [{ score: Number(funnel.traffic_rescue_clicks || 0), opportunity_type: "relance-accueil", url: "/", query: `${funnel.traffic_rescue_clicks || 0}/${funnel.traffic_rescue_shown || 0} clic(s)`, recommendation: "Comparer la relance accueil avec les starts formulaire et ajuster le texte si les visiteurs ferment sans cliquer." }] : []),
